%                              局部峰搜索法 -- LPS Method
%---------------------------------------------------------------------------------------------
% 【程序】 局部峰搜索法（LPS Method）- Lamb波频散方程求根方法。可用于以下模型
%        （1）自由或流体中，单、双层，弹性或粘弹性板；
%        （2）自由或流体中，单、双层，弹性或粘弹性圆柱壳。
% 【开发者】 龚家元，2009年始于哈尔滨工程大学水声工程学院，2011年改于中科院声学所北海站，2018年修改于湖北汽车工业学院。
% 【版权(c)2009-2018】 哈尔滨工程大学 & 中科院声学所北海站&湖北汽车工业学院。
% 【参考文献】 龚家元.水中覆阻尼层弹性板及柱壳中的漏Lamb波研究.哈尔滨工程大学硕士论文,2010.
% 【声明】 程序中柱壳方面存在问题，若有同仁对算法进行了优化或完善，希望能与作者分享，非常感谢。
% --------------------------------------------------------------------------------------------
...
% 【Developer】 Jiayuan Gong, first programmed at Harbin Engineering University(HEU),
%         Harbin, PRC, 2009; revised at Insititute of Acoustics, 
%         Chinese Academy of Sciences(IACAS), QingDao, PRC, 2011,
%         modified at Hubei University of Automotive Technology, Shiyan, PRC, 2018.
% 【Copyright(c)2009-2018】 By HEU and IACAS and HUAT.
%         This code is intended for educational or academical use only. No parts of
%         the code can be used for any commercial applications or distributions
...
%         Graduation Thesis of Master's Degree，Harbin Engineering University,2010.
